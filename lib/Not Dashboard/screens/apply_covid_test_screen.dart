...
class ApplyCovidTestScreen extends StatelessWidget {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        SizedBox(height: 65),
                        Text(
                          "Please Wait! You are not yet selected for Covid's Vaccination Programme",
                          style: TextStyle(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        Text(
                          "Congratulations! You have been selected for Covid's Vaccination Programme",
                          style: TextStyle(
                            fontWeight: FontWeight.w900,
