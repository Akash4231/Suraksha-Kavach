...
import 'package:covid19/Dashboard/data/network/api_client.dart';
import 'package:covid19/Dashboard/utils/constants.dart';
import 'package:covid19/Dashboard/utils/scroll_behaviour.dart';
import 'package:covid19/Dashboard/utils/utils.dart';
import 'package:covid19/Dashboard/widgets/dashboard_card.dart';
import 'package:covid19/Dashboard/widgets/data_card.dart';
import 'package:covid19/Dashboard/widgets/empty_state.dart';
import 'package:covid19/Dashboard/widgets/loader.dart';
...
class SummaryStatisticsScreen extends StatefulWidget {
  @override
  _SummaryStatisticsScreenState createState() =>
...
class _SummaryStatisticsScreenState extends State<SummaryStatisticsScreen> {
  ...
  void initState() {
    ...
    _chartColorList = [
      Constants.ACTIVE_COLOR_CODE,
      Constants.RECOVERED_COLOR_CODE,
      Constants.DEAD_COLOR_CODE
    ];
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        print(
            'Snapshot data: ${snapshot.hasData} & data loaded: ${statistic != null}');
