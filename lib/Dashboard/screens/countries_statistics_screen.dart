...
class CountriesStatisticsScreen extends StatefulWidget {
  @override
  _CountriesStatisticsScreenState createState() =>
      _CountriesStatisticsScreenState();
}

enum SortList { alphabetical, activeCases, recoveredCases, deadCases }
...
class _CountriesStatisticsScreenState extends State<CountriesStatisticsScreen> {
  ...
  // Data widget
  Widget showData(
      BuildContext context, List<Statistic> statistics, SortList sortList) {
  ...
  void sortListDialog(BuildContext context) {
    TextStyle checklistStyle =
        TextStyle(fontSize: 15, color: Colors.grey[600], letterSpacing: 1);
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: <Widget>[
              ColorKey(color: Constants.ACTIVE_COLOR_CODE, value: 'Active'),
              SizedBox(width: 15),
              ColorKey(
                  color: Constants.RECOVERED_COLOR_CODE, value: 'Recovered'),
              SizedBox(width: 15),
              ColorKey(color: Constants.DEAD_COLOR_CODE, value: 'Dead'),
            ],
          ),
          SizedBox(height: 10),
          child
